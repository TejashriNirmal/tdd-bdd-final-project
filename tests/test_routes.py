...
class TestProductRoutes(TestCase):
    ...
    def test_create_product(self):
        ...
        # Assert the location header is set
        ...
        self.assertEqual(new_product, {
            ...
            "available": test_product.available,
    ...
    def test_create_product_with_no_name(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST, "Expected 400 for product without a name")
